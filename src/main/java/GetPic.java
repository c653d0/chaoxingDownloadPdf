...
public class GetPic {
    ...
    public static void getPicFromHtml(String url, String path) {
        try {
    ...
    public static void getPicByNumber(int start,int end,String format,String path, String url){
        for(int i=start ; i<=end ; i++){
            savePic(path,i+".jpg",url+i+format);
        }
    }

    public static void savePic(String savePath, String saveName, String ul) {
        try {
            URL url = new URL(ul);
